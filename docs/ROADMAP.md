...
### nothrottle v2.0 — TUI de gestión de CPU Intel (proyecto separado)
- Reescritura completa como aplicación TUI (Rust+ratatui o Python+textual).
- Inspiración: btop++ (gráficas en tiempo real) + ThrottleStop (controles).
- Gráficas en tiempo real: frecuencias, temperaturas, power draw, voltaje.
- Controles interactivos: undervolt, TDP limits, PROCHOT, frecuencias.
- Benchmark integrado: super PI para test de estabilidad en tiempo real.
- Solo Intel 8th-14th Gen. Proyecto aislado con su propio repositorio.
- El instalador incluirá el binario precompilado cuando esté listo.
