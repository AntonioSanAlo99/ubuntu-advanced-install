...
# REQUIERE: TARGET, USERNAME, INSTALL_VSCODE, NODEJS_OPTION, INSTALL_TOPGRADE, INSTALL_BOXES, INSTALL_LAZY_TOOLS, INSTALL_BUN, INSTALL_DENO, INSTALL_DOCKER_TOOLS, INSTALL_N8N, INSTALL_MELD, INSTALL_POSTMAN, INSTALL_NETTOOLS
