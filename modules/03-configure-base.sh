...
# ============================================================================
# CONFIGURACIÓN DE LOCALE (simplificada para evitar conflictos)
# ============================================================================

# Solo /etc/default/locale (suficiente para la mayoría de casos)
cat > /etc/default/locale << 'LOC_EOF'
LANG=es_ES.UTF-8
LANGUAGE=es_ES:es
LOC_EOF

# localectl para systemd (sin LC_ALL para evitar conflictos)
localectl set-locale LANG=es_ES.UTF-8 2>/dev/null || true
