...
if [ -f /usr/share/applications/org.gnome.Totem.desktop ]; then
    cp /usr/share/applications/org.gnome.Totem.desktop \
       /usr/share/applications/org.gnome.Totem.desktop.bak
    if grep -q "^NoDisplay=" /usr/share/applications/org.gnome.Totem.desktop; then
        sed -i "s/^NoDisplay=.*/NoDisplay=true/" /usr/share/applications/org.gnome.Totem.desktop
    else
