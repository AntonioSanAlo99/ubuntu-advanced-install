...
# Aunque el módulo 02 ya escribe /etc/default/locale, el chroot no los
# carga automáticamente. Hay que exportarlos explícitamente para que
# cualquier invocación de Perl (usada internamente por dpkg/apt) los encuentre.
export LANG=C.UTF-8
