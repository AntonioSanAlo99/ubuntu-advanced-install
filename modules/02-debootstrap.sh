...
echo "✓  Repositorios configurados en formato DEB822:"
...
# Los locales se configuran en el módulo 03 mediante dpkg-reconfigure locales.
# El entorno hereda LC_ALL=C.UTF-8 desde run_module en install.sh,
# por lo que apt no genera warnings durante la instalación del paquete locales.
