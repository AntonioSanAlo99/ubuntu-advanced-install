...
arch-chroot "$TARGET" /bin/bash -c 'export DEBIAN_FRONTEND=noninteractive; apt update 2>&1' | grep -i "locale\|perl.*warning" | tee -a "$REPORT_FILE" || report "Sin warnings de locale"
report ""
