...
step " Archivo de configuración modular creado"
...
INTELEOF
    step " Optimizaciones Intel configuradas"
...
AMDMULTIEOF
        step " Optimizaciones AMD multi-CCD configuradas"
    else
...
kernel.numa_balancing = 0
AMDSINGLEEOF
        step " Optimizaciones AMD single-CCD configuradas"
    fi
fi
