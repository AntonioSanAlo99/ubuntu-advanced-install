...
step " Fuentes del sistema instaladas"
...
step " MS Core Fonts instaladas (Arial, Times New Roman, Verdana...)"
...
for font in "\${NERD_FONTS[@]}"; do
    ...
    if wget --timeout=30 --tries=3 -q --show-progress "\$NERD_BASE/\${font}.zip" -O "\${font}.zip" 2>/dev/null; then
...
echo ""
step " Módulo de fuentes completado"
