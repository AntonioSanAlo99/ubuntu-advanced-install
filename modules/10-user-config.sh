...
case "$EXT_METHOD" in
    1)
        # Método 1: gnome-extensions enable — activa una a una vía D-Bus
        # Añade cada extensión a la lista existente de enabled-extensions
    ...
    3)
        ...
        # Solo aseguramos que las extensiones de usuario no estén bloqueadas
        ;;
esac
