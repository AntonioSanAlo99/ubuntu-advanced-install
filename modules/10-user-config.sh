...
# ── Overview ──────────────────────────────────────────────────────────────────
# Workspaces y appgrid alfabético se configuran en dconf (10-install-gnome-core.sh)
# Aquí solo lo que necesita sesión D-Bus o es per-user
...
chroot "$TARGET" /bin/bash << AUTOSTARTEOF
