...
# Instalado desde GitHub en 10-install-gnome-core.sh
if [ -d /usr/share/icons/elementary-cursors ]; then
    gsettings set org.gnome.desktop.interface cursor-theme 'elementary-cursors'
    echo "✓  Cursor: elementary"
elif [ -d /usr/share/icons/elementary ] && [ -d /usr/share/icons/elementary/cursors ]; then
    gsettings set org.gnome.desktop.interface cursor-theme 'elementary'
    echo "✓  Cursor: elementary"
else
    echo "ℹ  Cursor elementary no encontrado — usando predeterminado"
fi
...
HIDDEN_APPS=(
    ...
    "display-im6.q16.desktop"                  # ImageMagick display (q16)
    "display-im6.q16hdri.desktop"              # ImageMagick display (q16hdri)
