...
# Habilitar extensiones — solo gnome-extensions enable, no sobrescribir lista dconf
# así el usuario puede instalar extensiones nuevas desde Extension Manager sin problemas
