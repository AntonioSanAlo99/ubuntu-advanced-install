...
step " gnome-software deshabilitado (~80-150MB)"
echo ""
...
TRACKER
    ...
    step " Tracker deshabilitado (~100-200MB)"
fi
...
ANIM
    ...
    step " Animaciones se deshabilitarán en primer login (~30-50MB)"
fi
...
EDS
    ...
    step " Evolution Data Server deshabilitado (~50-100MB)"
fi
