...
# REQUIERE: TARGET, INSTALL_SPOTIFY
# PRODUCE:  Códecs + VLC + Fooyin + thumbnailers
...
[ -z "${INSTALL_SPOTIFY:-}" ] && INSTALL_SPOTIFY=$(_yaml_val "multimedia" "spotify" "false")
...
if [ -f "\$SPOTIFY_DESKTOP" ]; then
    # Limpiar flags legacy de X11 si existen de instalaciones previas
...
[ "$INSTALL_SPOTIFY" = "true" ] && echo "  ✓ Spotify"
echo ""
