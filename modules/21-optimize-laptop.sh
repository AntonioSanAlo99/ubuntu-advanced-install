...
step " power-profiles-daemon configurado"
echo ""
...
CHROOTEOF
    ...
    echo ""
    step " power-profiles-daemon instalado"
...
step " TLP y thermald configurados"
echo ""
echo "Configuración:"
...
CHROOTEOF
    ...
    echo ""
    step " TLP instalado y configurado"
fi

echo ""
echo "════════════════════════════════════════════════════════════════"
step " OPTIMIZACIONES DE LAPTOP COMPLETADAS"
echo "════════════════════════════════════════════════════════════════"
echo ""
