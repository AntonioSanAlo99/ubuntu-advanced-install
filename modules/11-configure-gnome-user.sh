...
gsettings set org.gnome.desktop.app-folders.folder:/org/gnome/desktop/app-folders/folders/Gaming/ \
    translate false
gsettings set org.gnome.desktop.app-folders.folder:/org/gnome/desktop/app-folders/folders/Gaming/ \
    apps "['steam.desktop', 'heroic.desktop', 'faugus-launcher.desktop', 'com.vysp3r.ProtonPlus.desktop', 'io.github.radiolamp.mangojuice.desktop', 'discord.desktop', 'falcond-gui.desktop']"
...
gsettings set org.gnome.desktop.app-folders.folder:/org/gnome/desktop/app-folders/folders/Development/ \
    translate false
gsettings set org.gnome.desktop.app-folders.folder:/org/gnome/desktop/app-folders/folders/Development/ \
    apps "['code.desktop', 'com.mitchellh.ghostty.desktop', 'org.gnome.meld.desktop', 'postman.desktop']"
...
# ── Blur my Shell — aplicar en user dconf ─────────────────────────────────
# Las extensiones de terceros no leen del system-db de forma fiable.
# Se aplica via dconf write en el primer login con sesión D-Bus activa.
dconf write /org/gnome/shell/extensions/blur-my-shell/sigma 'uint32 0'
dconf write /org/gnome/shell/extensions/blur-my-shell/brightness '1.0'
dconf write /org/gnome/shell/extensions/blur-my-shell/color '(0.0, 0.0, 0.0, 0.0)'
dconf write /org/gnome/shell/extensions/blur-my-shell/noise-amount '0.0'
dconf write /org/gnome/shell/extensions/blur-my-shell/noise-lightness '0.0'
...
dconf write /org/gnome/shell/extensions/blur-my-shell/overview/sigma 'uint32 0'
dconf write /org/gnome/shell/extensions/blur-my-shell/overview/brightness '1.0'
dconf write /org/gnome/shell/extensions/blur-my-shell/overview/blur 'false'
dconf write /org/gnome/shell/extensions/blur-my-shell/overview/style-dialogs '1'
