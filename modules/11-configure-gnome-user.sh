...
gsettings set org.gnome.desktop.app-folders.folder:/org/gnome/desktop/app-folders/folders/Utilities/ \
    translate false
gsettings set org.gnome.desktop.app-folders.folder:/org/gnome/desktop/app-folders/folders/Utilities/ \
    apps "['org.gnome.Calculator.desktop', 'org.gnome.Evince.desktop', 'org.gnome.FileRoller.desktop', 'org.gnome.font-viewer.desktop', 'org.gnome.gedit.desktop', 'viewnior.desktop', 'org.gnome.Geary.desktop', 'com.github.johnfactotum.Foliate.desktop']"
...
gsettings set org.gnome.desktop.app-folders.folder:/org/gnome/desktop/app-folders/folders/System/ \
    translate false
gsettings set org.gnome.desktop.app-folders.folder:/org/gnome/desktop/app-folders/folders/System/ \
    apps "['gnome-control-center.desktop', 'org.gnome.tweaks.desktop', 'com.mattjakeman.ExtensionManager.desktop', 'org.gnome.DiskUtility.desktop', 'org.gnome.baobab.desktop', 'org.gnome.Logs.desktop', 'org.gnome.Terminal.desktop', 'lxtask.desktop', 'nm-connection-editor.desktop', 'gnome-language-selector.desktop', 'software-properties-gtk.desktop', 'update-manager.desktop', 'gdebi.desktop', 'io.github.thetumultuousunicornofdarkness.cpu-x.desktop', 'kdiskmark.desktop']"

# ── Carpeta Juegos ────────────────────────────────────────────────────────────
# Nombres de .desktop confirmados:
#   steam.desktop              → paquete steam-launcher (GLFS)
#   heroic.desktop             → .deb GitHub (Heroic Games Launcher)
#   faugus-launcher.desktop    → paquete faugus-launcher (PPA faugus)
#   com.vysp3r.ProtonPlus.desktop → compilación meson (upstream)
#   io.github.radiolamp.mangojuice.desktop → compilación meson (upstream)
#   discord.desktop            → .deb Discord (opcional)
#   unigine-heaven.desktop     → .run extraído (opcional)
gsettings set org.gnome.desktop.app-folders.folder:/org/gnome/desktop/app-folders/folders/Gaming/ \
    name 'Juegos'
gsettings set org.gnome.desktop.app-folders.folder:/org/gnome/desktop/app-folders/folders/Gaming/ \
    translate false
gsettings set org.gnome.desktop.app-folders.folder:/org/gnome/desktop/app-folders/folders/Gaming/ \
    apps "['steam.desktop', 'heroic.desktop', 'faugus-launcher.desktop', 'com.vysp3r.ProtonPlus.desktop', 'io.github.radiolamp.mangojuice.desktop', 'discord.desktop', 'unigine-heaven.desktop']"

# ── Carpeta Multimedia ───────────────────────────────────────────────────────
#   vlc.desktop                → paquete vlc
#   org.fooyin.fooyin.desktop  → .deb GitHub (Fooyin)
#   spotify.desktop            → repo Spotify (spotify-client)
gsettings set org.gnome.desktop.app-folders.folder:/org/gnome/desktop/app-folders/folders/Multimedia/ \
    name 'Multimedia'
gsettings set org.gnome.desktop.app-folders.folder:/org/gnome/desktop/app-folders/folders/Multimedia/ \
    translate false
gsettings set org.gnome.desktop.app-folders.folder:/org/gnome/desktop/app-folders/folders/Multimedia/ \
    apps "['vlc.desktop', 'org.fooyin.fooyin.desktop', 'spotify.desktop']"

# ── Carpeta Desarrollo ───────────────────────────────────────────────────────
#   code.desktop               → repo Microsoft (Visual Studio Code)
#   com.mitchellh.ghostty.desktop → .deb GitHub (Ghostty)
gsettings set org.gnome.desktop.app-folders.folder:/org/gnome/desktop/app-folders/folders/Development/ \
    name 'Desarrollo'
gsettings set org.gnome.desktop.app-folders.folder:/org/gnome/desktop/app-folders/folders/Development/ \
    translate false
gsettings set org.gnome.desktop.app-folders.folder:/org/gnome/desktop/app-folders/folders/Development/ \
    apps "['code.desktop', 'com.mitchellh.ghostty.desktop']"

# ── Carpeta Internet ────────────────────────────────────────────────────────
#   org.qbittorrent.qBittorrent.desktop → paquete qbittorrent
#   amule.desktop              → paquete amule (opcional)
#   mullvad-vpn.desktop        → repo Mullvad (opcional)
gsettings set org.gnome.desktop.app-folders.folder:/org/gnome/desktop/app-folders/folders/Internet/ \
    name 'Internet'
gsettings set org.gnome.desktop.app-folders.folder:/org/gnome/desktop/app-folders/folders/Internet/ \
    translate false
gsettings set org.gnome.desktop.app-folders.folder:/org/gnome/desktop/app-folders/folders/Internet/ \
    apps "['org.qbittorrent.qBittorrent.desktop', 'amule.desktop', 'mullvad-vpn.desktop']"

gsettings set org.gnome.desktop.app-folders folder-children "['Utilities', 'System', 'Gaming', 'Multimedia', 'Development', 'Internet']"
...
# Sustituir el placeholder de DING (iconos de escritorio) — opcional
if [ "${ENABLE_DESKTOP_ICONS:-false}" = "true" ]; then
    sed -i 's/DING_EXTENSION_PLACEHOLDER/"ding@rastersoft.com"/' \
        "$TARGET/usr/local/lib/ubuntu-advanced-install/gnome-first-login.sh"
    echo "  Desktop Icons NG: activado"
else
    sed -i '/DING_EXTENSION_PLACEHOLDER/d' \
        "$TARGET/usr/local/lib/ubuntu-advanced-install/gnome-first-login.sh"
    echo "  Desktop Icons NG: no activado (ENABLE_DESKTOP_ICONS=false)"
fi
