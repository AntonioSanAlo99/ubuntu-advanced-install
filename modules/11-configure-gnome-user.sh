...
EXT_LIST="'ubuntu-appindicators@ubuntu.com', '${DOCK_UUID}', 'user-theme@gnome-shell-extensions.gcampax.github.com', 'blur-my-shell@aunetx', 'AlphabeticalAppGrid@stuarthayhurst', 'caffeine@patapon.info', 'no-overview@fthx', 'no-screenshot-box@screenshot'"
