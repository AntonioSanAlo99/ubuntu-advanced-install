...
# PRODUCE:  Adwaita-Transparent en ~/.themes/
...
/* ── OVERVIEW: solo ventanas abiertas sobre escritorio limpio ──────────────
   Oculta la duplicación del escritorio (workspace thumbnails) y los
   indicadores de página. El overview muestra solo las ventanas abiertas
   flotando sobre el wallpaper nítido, sin miniaturas de workspace.
   ────────────────────────────────────────────────────────────────────────── */

/* Ocultar miniaturas de workspaces (la "duplicación" del escritorio) */
...
/* Ocultar indicadores de página de workspace (puntos de paginación) */
.page-indicators,
.page-indicator {
    opacity: 0 !important;
    height: 0 !important;
...
/* Overview: fondo completamente transparente (se ve el wallpaper) */
#overview, .overview, .overview-controls {
    background-color: transparent !important;
    background-image: none !important;
}

/* App grid: fondo transparente */
.app-grid, .apps-grid-container {
    background-color: transparent !important;
}

/* Workspace background en overview: transparente */
