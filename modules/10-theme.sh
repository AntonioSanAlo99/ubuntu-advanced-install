...
echo "════════════════════════════════════════════════════════════════"
echo ""
warn "  Este módulo es completamente opcional"
echo ""
...
if [ "$APPLY_THEME" != "s" ] && [ "$APPLY_THEME" != "S" ]; then
    echo ""
    step " Tema transparente omitido"
...
if [ -z "$USERNAME" ]; then
    warn " Variable USERNAME no definida"
    exit 1
fi
...
if [ ! -d "$USER_HOME" ]; then
    warn " Directorio home no existe: $USER_HOME"
    exit 1
fi
...
step " Tema creado en $USER_HOME/.themes/"

CHROOTEOF

echo ""
echo "════════════════════════════════════════════════════════════════"
step " TEMA TRANSPARENTE CONFIGURADO"
echo "════════════════════════════════════════════════════════════════"
echo ""
