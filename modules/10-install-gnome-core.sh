...
# Activación de extensiones → 10-user-config.sh (dconf load en chroot)
# ══════════════════════════════════════════════════════════════════════════════
...
# ============================================================================
# Defaults de sistema (sin locks). user-config.sh escribe la configuración
# definitiva del usuario via dconf load — sin script de primer arranque.
