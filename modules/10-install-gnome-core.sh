...
APPMANAGER_URL=\$(curl --max-time 30 --retry 3 -s https://api.github.com/repos/kem-a/AppManager/releases/latest | grep "browser_download_url.*x86_64.AppImage" | cut -d '"' -f 4)
