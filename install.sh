...
# ============================================================================
# STATUS — indicador de progreso por módulo
# ============================================================================

status_header() {
    # $1 = texto (e.g. "[3/18] Configuración base")
    # $2 = porcentaje (0-100)
    local text="$1"
    local percent="${2:-0}"
    local cols
...
run_module() {
    ...
    # Indicador de progreso: header al inicio del módulo
