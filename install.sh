...
_defaults_all_off() {
    # GNOME
    INSTALL_GNOME="false"; GNOME_OPTIMIZE_MEMORY="false"; GNOME_TRANSPARENT_THEME="false"
    GNOME_DOCK="dash-to-panel"; GDM_AUTOLOGIN="true"
    # Multimedia
    INSTALL_MULTIMEDIA="false"; INSTALL_SPOTIFY="false"
    # Desarrollo
    ...
    # Sistema
    MINIMIZE_SYSTEMD="true"; INSTALL_NOTHROTTLE="false"
    KERNEL_PARAMS_LEVEL="1"; AUTO_UPDATE_CHOICE="1"
}
