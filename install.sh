...
export_config_vars() {
    ...
    export UBUNTU_VERSION TARGET_DISK TARGET HOSTNAME USERNAME \
        ...
        STEAM_METHOD \
        INSTALL_CACHYOS_KERNEL PSYCACHY_SCHEDULER \
        INSTALL_FALCOND INSTALL_OPTISCALER \
        INSTALL_ONLYOFFICE INSTALL_QBITTORRENT INSTALL_MULLVAD \
        INSTALL_OBS INSTALL_OBSIDIAN \
        INSTALL_STREAMING_WEBAPPS \
        INSTALL_SYS_MANAGERS \
        INSTALL_BOXES INSTALL_LAZY_TOOLS INSTALL_BUN INSTALL_DENO \
        INSTALL_DOCKER_TOOLS INSTALL_MELD INSTALL_POSTMAN INSTALL_NETTOOLS \
