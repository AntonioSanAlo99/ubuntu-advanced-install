...
BANNER
    ...
    read -p "  ¿Apps extras (OnlyOffice, aMule, Mullvad)? (s/n) [n]: " inst_extras
    [[ ${inst_extras:-n} =~ ^[SsYy]$ ]] && INSTALL_EXTRAS="true" || INSTALL_EXTRAS="false"
    ...
    echo "  Gaming: $INSTALL_GAMING$([ "$INSTALL_GAMING" = "true" ] && echo " (ProtonPlus: $INSTALL_PROTONPLUS, Discord: $INSTALL_DISCORD, Unigine: $INSTALL_UNIGINE, GPU: $GPU_MANUAL)")"
    echo "  Extras: $INSTALL_EXTRAS$([ "$INSTALL_EXTRAS" = "true" ] && echo " (OnlyOffice: $INSTALL_ONLYOFFICE, aMule: $INSTALL_AMULE, Mullvad: $INSTALL_MULLVAD)")"
    echo ""
...
export_config_vars() {
    ...
    export UBUNTU_VERSION TARGET_DISK TARGET HOSTNAME USERNAME \
        ...
        INSTALL_EXTRAS INSTALL_ONLYOFFICE INSTALL_AMULE INSTALL_MULLVAD \
