...
modules/
  ...
  23-install-development.sh   Git, NodeJS, VSCode, Ghostty, Rust, eza, fzf, zoxide, yazi, lazy tools, Bun, Deno, Meld, Postman
...
| **Desarrollo (opcional)** | Lazy TUI (lazygit+lazydocker+LazyVim), Bun, Deno, Docker tools (unregistry+pussh+uncloud), Meld, Postman, GNOME Boxes |
...
| dconf system-db | `00-ubuntu-advanced-install` | welcome-dialog, experimental-features, blur-my-shell, Gradia keybindings |
