...
**P: Activé MEMORIA y el sistema se quedó sin memoria**
R: Con swappiness=1 el kernel evita usar swap agresivamente. Si tu sistema tiene
poca RAM (<4GB) o cargas muy pesadas, puede quedarse sin memoria. En ese caso,
desactiva esta optimización o aumenta tu swap.

**P: SCHEDULER no mejora mi compilación**
R: Depende del número de cores y del proyecto. En CPUs con 4 cores o menos el
beneficio es mínimo.
