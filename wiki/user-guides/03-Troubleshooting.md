...
El módulo `00-check-dependencies` lo instala automáticamente. Si el error ocurre antes de que ese módulo se ejecute, instálalo manualmente y vuelve a lanzar `./install.sh`.
...
4. Logs relevantes
5. Archivo config.yaml (sin contraseñas)
...
✅ Guardar config.yaml (sin contraseñas)
